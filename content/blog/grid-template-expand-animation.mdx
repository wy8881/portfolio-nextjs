...
<Callout title="In my project">
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 0, marginTop: 12 }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0', paddingRight: 52 }}>
      <span style={{ fontSize: 11, color: 'var(--color-secondary)', fontStyle: 'italic' }}>↕ 8px (mb-2)</span>
    </div>
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
...
<Callout title="In my project">
  ...
  <div style={{ marginTop: 12 }}>
    <div style={{ fontSize: 11, color: 'var(--color-secondary)', fontStyle: 'italic', marginBottom: 4, paddingLeft: 4 }}>← 8px (mr-2) →</div>
