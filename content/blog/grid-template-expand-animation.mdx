...
<CSSDemo
  ...
  previews={[
    ...
    <div style={{ fontFamily: 'monospace', fontSize: 13 }}>
      <div style={{ marginBottom: 6, color: 'var(--color-accent)' }}>click .wrapper to toggle</div>
      <div style={{ fontSize: 11, color: 'var(--color-secondary)' }}>
        (interactive toggle not shown in static preview — see transition tab code)
      </div>
    </div>,
  ]}
/>
